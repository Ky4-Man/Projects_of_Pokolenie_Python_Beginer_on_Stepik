...
def play(word):
    ...
    not_guessed_letters = []            # список уже названных букв
    not_guessed_words = []              # список уже названных слов
    tries = 6                           # количество попыток

    print('Давайте играть в угадайку слов!')
    print(display_hangman(tries))
    print()
    print(f'Ваше слово: {" ".join(word_completion)}')
    while True:
        tried_letter = input('Введите букву или слово целиком\n').upper()

        if len(tried_letter) > 1 and tried_letter == word:
            print('Поздравляем, вы угадали слово! Вы победили!')
            break
        elif tried_letter in not_guessed_words:
            print('Вы уже пробовали это слово, оно неверно.')
        elif len(tried_letter) > 1 and tried_letter != word:
            print('Вы ошиблись, ваше слово неверно.')
            tries -= 1
            not_guessed_words.append(tried_letter)

        if len(tried_letter) == 1 and tried_letter in letters and tried_letter not in guessed_letters:
            print('Правильно! Такая буква есть!')
            guessed_letters.append(tried_letter)
        elif len(tried_letter) == 1 and tried_letter not in letters and tried_letter not in not_guessed_letters:
            print('Ошибка! Такой буквы нет!')
            tries -= 1
        elif len(tried_letter) == 1 and tried_letter not in letters and tried_letter in not_guessed_letters:
            print('Вы уже вводили эту букву, её нет в загаданном слове!')

        if tries == 0:
            print('Вы проиграли!\n')
            display_hangman(tries)
            print(f'\nВаше слово было: {word.upper()}')
            break

        if set(guessed_letters) == set(letters):
            print('Поздравляем, вы угадали слово! Вы победили!')
